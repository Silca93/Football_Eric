  ...
  return (
    <div className='flex flex-col gap-3 justify-center items-center'>
        ...
        <div className="w-[30rem] h-[4rem] bg-blue-300  rounded-lg flex gap-5 text-white justify-center items-center">
          ...
          <Link to="/allteams">
            <button className='text-xl text-red-400 hover:text-green-300'>Logout Admin Mode</button>
          </Link>
        ...
        <div className="w-vw   flex gap-4 mx-3 flex-wrap my-3">
            {teams && teams.map((item, key) => (
                <div key={key} className="card w-96 border-[2px] border-green-300 bg-base-200 shadow-xl my-3">
                ...
                <div className="card-body h-[15rem]">
                  ...
                  <div className='flex gap-5'>
                    ...
                    <Link to="">
                      ...
                      <button className='btn btn-secondary w-[3rem]' onClick={(id) => deleteTeam(item.id)}>delete</button>
                  </div>
        ...
        <div className="w-[25rem] h-[25rem] rounded-lg bg-gray-300  border-black  border-[1px] ">
        <form onSubmit={create} className='flex flex-col gap-3 justify-center items-center bg-gray-300 rounded-lg border-black '>
                ...
                <button   className="input w-[20rem] hover:bg-black hover:text-white" type="submit">Create</button>
            </form>
        </div>
